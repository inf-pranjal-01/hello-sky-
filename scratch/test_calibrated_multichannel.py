...
def test_calibrated_system(seed=42):
    ...
    # Calibrated thresholds per channel:
    detector_T = ConditionalMultivariateDriftDetector(glrt_thresh=30.0, cusum_thresh=24.0, allowance=0.45, persist_req=2)
    detector_RH = ConditionalMultivariateDriftDetector(glrt_thresh=38.0, cusum_thresh=30.0, allowance=0.55, persist_req=3)
    detector_P = ConditionalMultivariateDriftDetector(glrt_thresh=32.0, cusum_thresh=26.0, allowance=0.45, persist_req=2)
...
if __name__ == '__main__':
    test_calibrated_system(seed=42)
