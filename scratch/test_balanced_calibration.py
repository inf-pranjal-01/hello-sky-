...
def run_balanced_rules(featured, thresholds):
...
def test_balanced_seed42():
    ...
    detector = ConditionalMultivariateDriftDetector(glrt_thresh=28.0, cusum_thresh=22.0, allowance=0.45, persist_req=2)
    ...
    featured_base, row_hard, row_rule_conf, row_fault_type = run_balanced_rules(featured.copy(), thresholds)
    ...
    print("\n--- BALANCED CALIBRATION RESULTS ON SEED 42 ---")
